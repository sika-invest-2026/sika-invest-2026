...
/* DATA_START */
const RAW = [
  // AFRICA GLOBAL LOGISTICS (SDSC) — nouveau nom
  {t:'SDSC',nom:'AFRICA GLOBAL LOG.',pays:'CI',sec:'IN',
   cours:1820, var:-7.38,vol:12470,div:6.5,per:9.5,per_s:10,
   hist:[1950,1920,1900,1880,1870,1890,1910,1930,1960,1970,
         1980,1990,1985,1975,1965,1960,1965,1965,1950,1820],
   actu:'Forte chute -7,4% séance. Rupture de support.',
   risq:'Tendance baissière confirmée. Risque de poursuite.'},

  {t:'BOAB',nom:'BOA BENIN',pays:'BJ',sec:'SF',
   cours:7845, var:2.08,vol:4067,div:8.5,per:9.2,per_s:9,
   hist:[6800,6900,7000,7050,7100,7080,7200,7300,7400,7500,
         7600,7700,7750,7850,7850,7700,7750,7700,7700,7845],
   actu:'Hausse +2,1%. Rebond après correction. BOA groupe en momentum.',
   risq:'PER dans la moyenne. Risque pays Bénin modéré.'},

  {t:'BOABF',nom:'BOA BURKINA',pays:'BF',sec:'SF',
   cours:5420, var:2.26,vol:3233,div:7.2,per:8.1,per_s:9,
   hist:[4600,4700,4800,4850,4900,4950,5000,5100,5200,5290,
         5290,5380,5400,5420,5380,5290,5380,5380,5380,5420],
   actu:'Hausse +2,3% après rebond +12% sem. 9–13 mars. Momentum fort.',
   risq:'Risque politique Burkina. RSI en zone haute.'},

  {t:'BOAC',nom:'BOA CI',pays:'CI',sec:'SF',
   cours:8940, var:0.45,vol:3767,div:7.0,per:9.5,per_s:9,
   hist:[8000,8100,8150,8200,8250,8300,8200,8300,8300,8300,
         8300,8900,8900,8900,8900,8900,8900,8900,8900,8940],
   actu:'Légère hausse +0,5%. Cours stabilisé après fort momentum.',
   risq:'PER légèrement supérieur à la moyenne sectorielle.'},

  {t:'BOAM',nom:'BOA MALI',pays:'ML',sec:'SF',
   cours:4785, var:0.31,vol:4765,div:7.2,per:7.5,per_s:9,
   hist:[4500,4520,4550,4600,4620,4650,4680,4700,4720,4750,
         4760,4765,4765,4765,4765,4765,4765,4765,4765,4785],
   actu:'Cours en légère hausse. Profil stable. Dividende correct.',
   risq:'Risque géopolitique Mali élevé. Liquidité faible.'},

  {t:'BOAN',nom:'BOA NIGER',pays:'NE',sec:'SF',
   cours:2610, var:-4.40,vol:20168,div:6.0,per:8.8,per_s:9,
   hist:[3000,2980,2950,2920,2900,2850,2800,2780,2750,2720,
         2700,2680,2660,2640,2620,2600,2600,2600,2730,2610],
   actu:'PROFIT WARNING 13/03/2026. Chute -4,4%. Éviter absolument.',
   risq:'PROFIT WARNING officiel. Risque de chute supplémentaire.'},

  {t:'BOAS',nom:'BOA SENEGAL',pays:'SN',sec:'SF',
   cours:6900, var:1.17,vol:17974,div:8.1,per:7.9,per_s:9,
   hist:[6200,6300,6350,6400,6450,6500,6550,6600,6650,6700,
         6750,6800,6820,6850,6850,6850,6850,6880,6880,6900],
   actu:'Hausse +1,2%. Volume élevé. Tendance haussière soutenue.',
   risq:'Compétition bancaire sénégalaise. Liquidité correcte.'},

  {t:'BICB',nom:'BIC BENIN',pays:'BJ',sec:'SF',
   cours:5200, var:-0.95,vol:947,div:8.2,per:6.5,per_s:9,
   hist:[5100,5120,5150,5180,5200,5220,5220,5220,5220,5220,
         5220,5220,5220,5220,5220,5220,5220,5220,5220,5200],
   actu:'Légère correction -0,9%. PER attractif 6,5x. Dividende 8,2%.',
   risq:'Faible liquidité (947 titres échangés).'},

  {t:'BNBC',nom:'BERNABE CI',pays:'CI',sec:'IN',
   cours:1575, var:-2.17,vol:1911,div:7.0,per:7.1,per_s:10,
   hist:[1700,1680,1660,1650,1640,1630,1620,1610,1600,1590,
         1580,1580,1580,1580,1590,1600,1605,1605,1605,1575],
   actu:'Baisse -2,2%. Tendance baissière persistante.',
   risq:'Tendance baissière. Manque de catalyseur.'},

  {t:'BICC',nom:'BICICI CI',pays:'CI',sec:'SF',
   cours:26000, var:0.39,vol:408,div:7.8,per:7.2,per_s:9,
   hist:[25000,25200,25400,25500,25600,25700,25800,25900,26000,
         26000,26000,26000,26000,26000,26000,26000,26000,26000,26000,26000],
   actu:'Cours très stable. Faible volume. Dividende 7,8% attractif.',
   risq:'Liquidité très faible. Difficile d\'entrer/sortir.'},

  {t:'CABC',nom:'SICABLE CI',pays:'CI',sec:'IN',
   cours:3245, var:-1.07,vol:813,div:7.5,per:6.1,per_s:10,
   hist:[4200,4100,4000,3900,3800,3700,3600,3500,3400,3290,
         3290,3290,3290,3290,3250,3250,3250,3250,3250,3245],
   actu:'Chute de -17,3% sem. 9–13 mars après publication états financiers négatifs.',
   risq:'RSI en survente. Attendre confirmation de stabilisation.'},

  {t:'CBIBF',nom:'CORIS BANK BF',pays:'BF',sec:'SF',
   cours:13510, var:0.04,vol:4943,div:9.2,per:6.7,per_s:9,
   hist:[12000,12200,12400,12500,12700,12800,13000,13100,13200,
         13300,13400,13500,13500,13500,13505,13505,13505,13505,13505,13510],
   actu:'Cours stable. BN +28% 2024. Dividende 9,2% supérieur au marché.',
   risq:'Risque pays Burkina. Faible variation du cours récemment.'},

  {t:'CFAC',nom:'CFAO MOTORS CI',pays:'CI',sec:'CD',
   cours:1760, var:0.86,vol:3644,div:5.2,per:9.5,per_s:11,
   hist:[1850,1830,1810,1790,1770,1750,1730,1720,1710,1700,
         1680,1670,1660,1650,1650,1745,1745,1745,1745,1760],
   actu:'Légère reprise +0,9%. Rebond après forte correction.',
   risq:'Tendance baissière de fond. Secteur auto difficile.'},

  {t:'CIEC',nom:'CIE CI',pays:'CI',sec:'EN',
   cours:3200, var:-3.03,vol:2661,div:8.5,per:8.2,per_s:10,
   hist:[3600,3580,3550,3520,3500,3480,3450,3420,3400,3380,
         3350,3320,3300,3300,3300,3300,3300,3300,3300,3200],
   actu:'Baisse -3,0%. Énergie CI sous pression. Dividende 8,5% attractif.',
   risq:'Tendance baissière. Secteur énergie régulé.'},

  {t:'ECOC',nom:'ECOBANK CI',pays:'CI',sec:'SF',
   cours:16795, var:3.16,vol:2940,div:5.0,per:12.4,per_s:9,
   hist:[13000,13500,14000,14200,14500,14700,15000,15200,15500,
         15700,16000,16200,16215,16215,16215,16215,16215,16215,16215,16795],
   actu:'Fort rebond +3,2%. Hausse continue depuis janvier. Momentum.',
   risq:'PER 12,4x supérieur au secteur. Valorisation tendue.'},

  {t:'ETIT',nom:'ETI TG',pays:'TG',sec:'SF',
   cours:32, var:0.00,vol:582860,div:0,per:5.1,per_s:9,
   hist:[20,20,20,20,20,22,22,24,24,26,28,28,30,30,30,32,32,32,32,32],
   actu:'Cours stable à 32 FCFA. Volume énorme. Zéro dividende malgré BN record.',
   risq:'Aucun dividende. Sans catalyseur de cours clair.'},

  {t:'FTSC',nom:'FILTISAC CI',pays:'CI',sec:'IN',
   cours:2315, var:1.09,vol:1769,div:8.8,per:7.2,per_s:10,
   hist:[2100,2120,2150,2180,2200,2220,2220,2240,2250,2260,
         2270,2275,2275,2275,2275,2275,2275,2275,2275,2315],
   actu:'Hausse +1,1%. Dividende 8,8% attractif. Emballages CI.',
   risq:'Faible liquidité. Volume limité.'},

  {t:'LNBB',nom:'LOTERIE NAT. BENIN',pays:'BJ',sec:'CD',
   cours:3850, var:1.32,vol:702,div:6.5,per:8.0,per_s:11,
   hist:[3500,3550,3600,3620,3650,3680,3700,3720,3750,3770,
         3800,3800,3800,3800,3800,3800,3800,3800,3800,3850],
   actu:'Hausse progressive +1,3%. Niche stable.',
   risq:'Très faible liquidité. Valeur de niche.'},

  {t:'NEIC',nom:'NEI CEDA CI',pays:'CI',sec:'CD',
   cours:1410, var:0.00,vol:1689,div:7.1,per:6.5,per_s:11,
   hist:[1400,1400,1400,1400,1400,1400,1400,1400,1400,1400,
         1410,1410,1410,1410,1410,1410,1410,1410,1410,1410],
   actu:'Cours bloqué. Notation financière publiée 03/03/2026.',
   risq:'Illiquidité totale. Ordres difficiles à exécuter.'},

  {t:'NSBC',nom:'NSIA BANQUE CI',pays:'CI',sec:'SF',
   cours:14000, var:-1.41,vol:741,div:5.8,per:11.2,per_s:9,
   hist:[14500,14400,14300,14200,14100,14050,14000,14000,14000,
         14200,14200,14200,14200,14200,14200,14200,14200,14200,14200,14000],
   actu:'Légère correction -1,4%. Faible liquidité. PER élevé.',
   risq:'PER 11,2x élevé. Liquidité très faible.'},

  {t:'NTLC',nom:'NESTLE CI',pays:'CI',sec:'CB',
   cours:12890, var:-0.08,vol:296,div:5.5,per:13.5,per_s:8,
   hist:[13000,13000,13000,13000,13000,13000,12900,12900,12900,
         12900,12900,12900,12900,12900,12900,12900,12900,12900,12900,12890],
   actu:'Cours quasi-stable. PER 13,5x élevé. Valeur défensive.',
   risq:'PER le plus élevé du secteur. Croissance limitée.'},

  {t:'ONTBF',nom:'ONATEL BF',pays:'BF',sec:'TEL',
   cours:2835, var:-4.87,vol:897,div:10.5,per:7.1,per_s:9,
   hist:[2500,2520,2550,2580,2600,2620,2640,2660,2700,2740,
         2760,2800,2835,2980,2980,2980,2980,2980,2980,2835],
   actu:'Correction -4,9% après forte hausse récente. Dividende 10,5%.',
   risq:'RSI en correction après surachat. Risque Burkina.'},

  {t:'ORAC',nom:'ORANGE CI',pays:'CI',sec:'TEL',
   cours:15050, var:0.00,vol:500,div:7.2,per:12.8,per_s:9,
   hist:[14000,14100,14200,14300,14400,14500,14600,14700,14800,
         14900,15000,15025,15025,15025,15025,15025,15025,15025,15025,15050],
   actu:'Cours stable. 5G en déploiement. Croissance continue.',
   risq:'PER 12,8x élevé. Faible volume.'},

  {t:'ORGT',nom:'ORAGROUP TG',pays:'TG',sec:'SF',
   cours:3500, var:-5.41,vol:11074,div:7.5,per:7.1,per_s:9,
   hist:[2800,2900,3000,3100,3200,3300,3400,3500,3600,3700,
         3740,3740,3740,3740,3740,3700,3700,3700,3700,3500],
   actu:'Correction -5,4% après hausse +13% sem. 2–6 mars. RSI en descente.',
   risq:'Volatilité élevée. Correction en cours après fort mouvement.'},

  {t:'PALC',nom:'PALM CI',pays:'CI',sec:'CB',
   cours:9305, var:-1.43,vol:2709,div:17.0,per:2.5,per_s:8,
   hist:[8500,8600,8700,8800,8900,9000,9100,9200,9300,9440,
         9440,9440,9440,9440,9440,9440,9440,9440,9440,9305],
   actu:'Légère correction -1,4%. PER 2,5x plancher. Dividende 17% exceptionnel.',
   risq:'BN très cyclique. Cours dépend des prix mondiaux du palm.'},

  {t:'SAFC',nom:'SAFCA CI',pays:'CI',sec:'SF',
   cours:5780, var:0.52,vol:1049,div:8.9,per:6.2,per_s:9,
   hist:[4970,5000,5100,5200,5300,5400,5500,5550,5600,5650,
         5700,5750,5750,5750,5750,5750,5750,5750,5750,5780],
   actu:'Hausse progressive. Notation financière positive 03/03/2026.',
   risq:'Faible capitalisation. Liquidité modérée.'},

  {t:'SPHC',nom:'SAPH CI',pays:'CI',sec:'CB',
   cours:8350, var:-0.54,vol:474,div:12.5,per:3.6,per_s:8,
   hist:[3000,3000,3100,3200,3500,4000,5000,6000,7000,8000,
         8300,8400,8400,8400,8400,8400,8400,8400,8400,8350],
   actu:'PER 3,6x et dividende 12,5%. Légère correction. Cours a fortement rebondi.',
   risq:'BN en perte 2023. Rebond fragile. Dépend cours latex.'},

  {t:'ABJC',nom:'SERVAIR CI',pays:'CI',sec:'IN',
   cours:3250, var:0.00,vol:1016,div:6.2,per:8.0,per_s:10,
   hist:[4000,3900,3800,3700,3600,3500,3400,3395,3395,3395,
         3395,3395,3395,3395,3395,3395,3395,3245,3245,3250],
   actu:'Cours stable après forte baisse récente (-8,4% sem. précédente).',
   risq:'Tendance baissière de long terme.'},

  {t:'STAC',nom:'SETAO CI',pays:'CI',sec:'IN',
   cours:2285, var:-7.30,vol:6264,div:6.5,per:7.2,per_s:10,
   hist:[1400,1500,1600,1700,1800,1900,2000,1900,1900,1900,
         1900,1900,1900,1900,1900,2660,2660,2660,2445,2285],
   actu:'Correction -7,3% après hausse exceptionnelle +40% sem. 9–13 mars. RSI retombe.',
   risq:'Extrêmement volatile. Correction en cours après +40%.'},

  {t:'SGBC',nom:'SGBCI',pays:'CI',sec:'SF',
   cours:36000, var:3.15,vol:313,div:5.3,per:14.5,per_s:9,
   hist:[30000,30500,31000,31500,32000,32500,33000,33500,34000,
         34500,35000,35010,35010,35010,35010,35010,35010,35010,35010,36000],
   actu:'Forte hausse +3,2%. Cours au plus haut. PER élevé mais momentum fort.',
   risq:'PER 14,5x le plus élevé du secteur. Valorisation tendue.'},

  {t:'SEMC',nom:'CROWN SIEM CI',pays:'CI',sec:'IN',
   cours:1975, var:0.00,vol:3165,div:7.0,per:5.5,per_s:10,
   hist:[2800,2700,2600,2500,2400,2300,2200,2100,2000,1995,
         1975,1975,1975,1975,1975,1975,1975,1975,1975,1975],
   actu:'Cours stabilisé après chute -11,3% sem. 9–13 mars. RSI en survente.',
   risq:'Rebond technique possible mais tendance baissière de fond.'},

  {t:'SIVC',nom:'ERIUM CI',pays:'CI',sec:'EN',
   cours:2690, var:-0.19,vol:2260,div:9.0,per:6.5,per_s:10,
   hist:[3000,2950,2900,2850,2800,2750,2700,2695,2695,2695,
         2695,2695,2695,2695,2695,2695,2695,2695,2695,2690],
   actu:'Légère baisse -0,2%. Dividende 9% au-dessus du marché.',
   risq:'Tendance baissière lente. Surveiller support.'},

  {t:'SVOC',nom:'MOVIS CI',pays:'CI',sec:'IN',
   cours:2395, var:0.00,vol:0,div:5.0,per:9.0,per_s:10,
   hist:[2395,2395,2395,2395,2395,2395,2395,2395,2395,2395,
         2395,2395,2395,2395,2395,2395,2395,2395,2395,2395],
   actu:'Zéro volume échangé. Illiquidité totale. À éviter pour un concours.',
   risq:'ILLIQUIDITÉ TOTALE. Impossible de passer des ordres.'},

  {t:'SLBC',nom:'SOLIBRA CI',pays:'CI',sec:'CB',
   cours:39510, var:0.00,vol:0,div:6.0,per:11.4,per_s:8,
   hist:[55000,50000,47000,44075,44075,44075,44000,40000,38000,
         35705,35705,35705,35705,39510,39510,39510,39510,39510,39510,39510],
   actu:'Cours stable après très forte volatilité (−19% puis +10,7%). Volume nul.',
   risq:'Extrêmement volatile. Volume nul aujourd\'hui. Attendre.'},

  {t:'SNTS',nom:'SONATEL',pays:'SN',sec:'TEL',
   cours:26695, var:0.00,vol:0,div:8.9,per:4.7,per_s:9,
   hist:[25000,25200,25400,25500,25600,25700,25800,25900,26000,
         26100,26200,26300,26400,26500,26600,26695,26695,26695,26695,26695],
   actu:'Cours stable. Leader BRVM. PER 4,7x très attractif. BN +18,7% 2024.',
   risq:'Manque de momentum récent malgré excellents fondamentaux.'},

  {t:'SDSC',nom:'AGL CI',pays:'CI',sec:'IN',
   cours:1820, var:-7.38,vol:12470,div:6.5,per:9.5,per_s:10,
   hist:[2000,1980,1960,1940,1920,1910,1910,1960,1965,1965,
         1965,1965,1965,1965,1965,1965,1965,1965,1965,1820],
   actu:'Forte chute -7,4%. Rupture de support technique.',
   risq:'Tendance baissière. Signal négatif fort.'},

  {t:'SOGB',nom:'SOGB CI',pays:'CI',sec:'CB',
   cours:8350, var:0.00,vol:0,div:13.5,per:3.8,per_s:8,
   hist:[8000,8000,8100,8200,8300,8400,8500,8500,8500,8500,
         8500,8500,8500,8500,8500,8500,8500,8500,8500,8350],
   actu:'PER 3,8x et dividende 13,5% parmi les meilleurs BRVM. Volume nul.',
   risq:'Volume nul. Très difficile d\'acheter/vendre.'},

  {t:'SCRC',nom:'SUCRIVOIRE CI',pays:'CI',sec:'CB',
   cours:1550, var:0.00,vol:0,div:12.1,per:5.5,per_s:8,
   hist:[1700,1680,1660,1640,1620,1600,1580,1560,1550,1550,
         1550,1550,1550,1550,1550,1550,1550,1550,1550,1550],
   actu:'Cours en correction depuis 3 semaines. Dividende 12,1% attractif.',
   risq:'Cyclique. Cours en baisse. Volume nul aujourd\'hui.'},

  {t:'STLC',nom:'TOTAL CI',pays:'CI',sec:'EN',
   cours:2395, var:0.00,vol:0,div:9.8,per:6.8,per_s:10,
   hist:[2000,2050,2100,2150,2200,2250,2300,2345,2345,2345,
         2345,2345,2345,2345,2345,2345,2345,2345,2345,2395],
   actu:'Cours en légère hausse. Dividende 9,8% très attractif. Énergie stable.',
   risq:'Secteur pétrolier sous pression mondiale.'},

  {t:'TTLS',nom:'TOTAL SENEGAL',pays:'SN',sec:'EN',
   cours:3285, var:0.00,vol:0,div:9.1,per:7.2,per_s:10,
   hist:[2600,2700,2800,2900,3000,3100,3200,3285,3285,3285,
         3285,3285,3285,3285,3285,3285,3285,3285,3285,3285],
   actu:'Hausse +12,9% sem. 2–6 mars. Stable depuis. Dividende 9,1%.',
   risq:'Volume nul aujourd\'hui. Liquidité fluctuante.'},

  {t:'PRSC',nom:'TRACTAFRIC CI',pays:'CI',sec:'CD',
   cours:4885, var:0.00,vol:0,div:6.5,per:8.5,per_s:11,
   hist:[3800,3900,4000,4200,4500,4800,5405,5405,5200,5000,
         4885,4885,4885,4885,4885,4885,4885,4885,4885,4885],
   actu:'Stabilisation après +18,8% puis -9,6%. Très volatile. Surveiller.',
   risq:'Volatilité extrême. Volume nul. Éviter pour l\'instant.'},

  {t:'UNLC',nom:'UNILEVER CI',pays:'CI',sec:'CB',
   cours:16000, var:0.00,vol:0,div:5.5,per:13.5,per_s:8,
   hist:[17000,16800,16600,16400,16200,16000,16000,16000,16000,
         16000,16000,16000,16000,16000,16000,16000,16000,16000,16000,16000],
   actu:'AGO convoquée 11/03/2026. Cours stable. PER élevé 13,5x.',
   risq:'PER très élevé. Tendance stable sans momentum.'},

  {t:'UNXC',nom:'UNIWAX CI',pays:'CI',sec:'IN',
   cours:1980, var:0.00,vol:0,div:8.2,per:7.1,per_s:10,
   hist:[3000,2900,2800,2700,2600,2500,2400,2300,2200,2100,
         1980,1980,1980,1980,1980,1980,1980,1980,1980,1980],
   actu:'Stabilisation après chute -12% sem. 9–13 mars. RSI en survente.',
   risq:'RSI en survente. Rebond possible si volume revient.'},

  {t:'SHEC',nom:'VIVO ENERGY CI',pays:'CI',sec:'EN',
   cours:2240, var:0.00,vol:0,div:9.5,per:8.1,per_s:10,
   hist:[1600,1700,1800,1900,2000,2100,2200,2240,2240,2240,
         2240,2240,2240,2240,2240,2240,2240,2240,2240,2240],
   actu:'Stable après forte hausse +10,6% sem. 2–6 mars. Dividende 9,5%.',
   risq:'Volume nul. Consolidation en cours.'},

  {t:'SIBC',nom:'SIB CI',pays:'CI',sec:'SF',
   cours:7200, var:0.00,vol:0,div:7.1,per:9.8,per_s:9,
   hist:[6500,6600,6700,6800,6900,7000,7100,7200,7200,7200,
         7200,7200,7200,7200,7200,7200,7200,7200,7200,7200],
   actu:'Cours stable. Filiale Attijariwafa. Hausse progressive depuis jan.',
   risq:'Volume nul aujourd\'hui. Liquidité variable.'},

  {t:'SICC',nom:'SICOR CI',pays:'CI',sec:'IN',
   cours:4095, var:0.00,vol:0,div:8.8,per:6.1,per_s:10,
   hist:[4300,4100,3900,3700,3500,3635,3635,3635,3710,3710,
         3710,4095,4095,4095,4095,4095,4095,4095,4095,4095],
   actu:'Stable après rebond +10,4% sem. 9–13 mars. Volume nul.',
   risq:'Très faible liquidité. Exécution des ordres difficile.'},
];
/* DATA_END */
